      ...
      {methods.map((method) => {
        ...
        return (
          <button
            ...
            className={`flex w-full items-center gap-4 border-b px-5 py-5 text-left transition
              ${
               active
? "border-l-4 border-l-[#2454b5] bg-gradient-to-r from-[#eef4ff] via-white to-white shadow-md"
                  : "hover:bg-white"
              }`}
          >
            <Icon
